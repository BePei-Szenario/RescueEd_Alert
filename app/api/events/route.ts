...
export async function POST(request:Request){
 try{
  ...
  if((owner.accountType==="consumer"||!organization.unlimitedEventDuration)&&durationMinutes>STANDARD_EVENT_MAX_MINUTES)return Response.json({error:"Events dürfen höchstens 5 Tage dauern. Längere Events sind nur für Dauernutzer-Organisationen möglich."},{status:400});
