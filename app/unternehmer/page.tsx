...
export default async function UnternehmerPage(){
 ...
 const [[orgCount],[userCount],[eventCount],[bookingCount],customers,archives,bookings,emailSettings,storedLegalDocuments,legalVersions,logs]=await Promise.all([
  ...
  db.select({documentKey:legalDocuments.documentKey,title:legalDocuments.title,version:legalDocuments.version,content:legalDocuments.content,pdfFileName:legalDocuments.pdfFileName,status:legalDocuments.status}).from(legalDocuments),
  db.select({id:legalDocumentVersions.id,documentKey:legalDocumentVersions.documentKey,title:legalDocumentVersions.title,version:legalDocumentVersions.version,content:legalDocumentVersions.content,pdfFileName:legalDocumentVersions.pdfFileName,contentHash:legalDocumentVersions.contentHash,publishedAt:legalDocumentVersions.publishedAt,archivedAt:legalDocumentVersions.archivedAt}).from(legalDocumentVersions).orderBy(desc(legalDocumentVersions.publishedAt)),
